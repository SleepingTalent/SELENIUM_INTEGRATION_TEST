...
public class DeleteEmployeeDialog extends PageObject {

    private static final String FORM = "deleteEmployee";
    private static final String DELETE_EMPLOYEE_DIALOG = "deleteEmployeeDialog";
    ...
    private static final String DELETE_EMPLOYEE_BTN = "deleteEmployeeBtn";

    public DeleteEmployeeDialog(WebDriver driver) {
        super(driver);
    }
